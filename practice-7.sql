...
SELECT listings.property_type, COUNT(reviews.id),MAX(date_reviewed) FRom reviews INNER JOIN listings on listings.id = reviews.listing_id GRoup by property_type;
